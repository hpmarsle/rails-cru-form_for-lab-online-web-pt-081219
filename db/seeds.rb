...
@song2 = Song.create(name: "Sadness Etc", artist: @artist1, genre: @genre2)
@song3 = Song.create(name: "Hip Happiness", artist: @artist2, genre: @genre2)
@song4 = Song.create(name: "NSFW Outfits", artist: @artist3, genre: @genre4)
